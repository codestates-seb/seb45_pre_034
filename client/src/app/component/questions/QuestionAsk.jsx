            ...
            <section className={styles.section}>
                ...
                <form action="#">
                    <div className={styles.flex}>
                        <div className={`${styles.problem_title} ${styles.problem_container}`}>
                            <div>
                                <div>
                        ...
                        {/* <div className={`${styles.advice} ${styles.problem_container}`}>
                    ...
                    <div className={`${styles.problem_details} ${styles.problem_container}`}>
                        <div>
                    ...
                    <div className={`${styles.problem_results} ${styles.problem_container}`}>
                        <div>
